...
function createEventForm(atendeeID, atendeeArray) {
    ...
    document.querySelector('.btn-create-event').addEventListener('click', function(event) {
        ...
        const eventOrganiser = document.querySelector('#create-event-organiser')
        const eventOrganiserFeedback = document.querySelector('.create-event-organiser-feedback')
    ...
    if (hasEndDate) {
       ...
       if (hasEndDateGreaterOrEqaulToStartDate === "greater") {
        ...
        if (hasEventOrganiser && hasEventName && hasEventDescription && hasEndDate && hasEndDate && hasEventEndTime && hasEventStartTime && hasHouseNumber && hasStreet && hasCity && hasCountry && hasCounty && hasEventTicketPrice && hasEventTicketAmount && hasEndTimeGreaterThanStartTime && hasEndDateGreaterOrEqaulToStartDate === "greater", hasImage) {
            //add back end here.
            createEvent ()
